...
import PromotionTypeElixirTemplateValidatorFactory from "../factory/promotionTypeElixirTemplate.validator.factory";

export default class PromotionTypeElixirTemplate extends Component implements UseTemplateInterface {

  _templatePath: string = 'src/domain/promotionTypeElixirTemplate/template';
  ...
  validate() {
    PromotionTypeElixirTemplateValidatorFactory.create().validate(this)
