...
export default class UseCleanElixirTemplateYupValidator implements ValidatorInterface<UseCleanElixirTemplate> {
  validate(component: UseCleanElixirTemplate): void {
